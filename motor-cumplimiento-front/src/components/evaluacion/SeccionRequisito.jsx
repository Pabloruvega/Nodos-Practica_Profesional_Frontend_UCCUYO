 ...
 *
 * Uso:
 *   <SeccionRequisito emoji="🛡️" titulo="REQ-001 · Seguro de Accidentes">
 *     <Campo ... />
 *     <Campo ... />
 *   </SeccionRequisito>
 *
  ...
  return (
    <Card className="bg-zinc-900 border-zinc-800">
      <CardHeader className="pb-3">
        <CardTitle className="text-sm font-semibold tracking-widest uppercase text-zinc-400 flex items-center gap-2">
          <span>{emoji}</span>
          <span>{titulo}</span>
        </CardTitle>
      </CardHeader>
