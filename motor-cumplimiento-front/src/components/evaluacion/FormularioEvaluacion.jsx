...
const FORM_INICIAL = {
  nombre: "",
  seguro_accidentes: {
    numero_poliza: "", aseguradora: "", fecha_inicio: "",
    fecha_vencimiento: "", numero_trabajadores_cubiertos: "",
  },
  registro_proveedor: {
    numero_registro: "", entidad_registradora: "", fecha_inscripcion: "",
    estado_registro: "", fecha_vencimiento: "",
  },
  certificado_seguridad: {
    numero_certificado: "", entidad_emisora: "", resultado: "",
    fecha_emision: "", fecha_vencimiento: "", periodo_evaluado_meses: "",
  },
  acreditacion_personal: {
    total_trabajadores: "", trabajadores_certificados: "", porcentaje_cobertura: "",
    fecha_ultima_actualizacion: "", organismo_certificador: "",
  },
  plan_emergencia: {
    tiene_plan: "", fecha_ultima_revision: "", aprobado_por: "",
    version: "", simulacros_realizados_anio: "",
  },
};

const FORM_EJEMPLO = {
  nombre: "Minera Andina S.A.",
  seguro_accidentes: { numero_poliza: "POL-2024-789", aseguradora: "Seguros del Norte", fecha_inicio: "2024-01-01", fecha_vencimiento: "2026-12-31", numero_trabajadores_cubiertos: "45" },
  registro_proveedor: { numero_registro: "RPM-2023-456", entidad_registradora: "SERNAGEOMIN", fecha_inscripcion: "2023-03-15", estado_registro: "activo", fecha_vencimiento: "2026-03-15" },
  certificado_seguridad: { numero_certificado: "CERT-SEG-2025-112", entidad_emisora: "Instituto de Seguridad Minera", resultado: "aprobado", fecha_emision: "2025-11-01", fecha_vencimiento: "2026-11-01", periodo_evaluado_meses: "14" },
  acreditacion_personal: { total_trabajadores: "45", trabajadores_certificados: "40", porcentaje_cobertura: "88.9", fecha_ultima_actualizacion: "2024-06-15", organismo_certificador: "ACHS" },
  plan_emergencia: { tiene_plan: "true", fecha_ultima_revision: "2025-09-20", aprobado_por: "Gerencia de Seguridad", version: "v3.2", simulacros_realizados_anio: "3" },
};
    ...
    <div className="space-y-1">
      ...
      <Select value={value} onValueChange={onChange}>
        ...
        <SelectContent className="bg-card border-border">
          {opciones.map((op) => (
            <SelectItem key={op.value} value={op.value} className="text-foreground">{op.label}</SelectItem>
          ))}
        </SelectContent>
      </Select>
    </div>
...
export default function FormularioEvaluacion({ onResultado }) {
    ...
    return (
      <div className="space-y-4 animate-pulse">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <SeccionSkeleton /><SeccionSkeleton />
          <SeccionSkeleton /><SeccionSkeleton />
          <div className="col-span-2 flex justify-center">
            <div className="w-[calc(50%-8px)]"><SeccionSkeleton /></div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Barra de progreso */}
      <BarraProgreso completadas={seccionesCompletas} total={5} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <SeccionRequisito emoji="" titulo="REQ-002 · Registro de Proveedor Minero">
          ...
          <CampoSelect label="Estado Registro" value={form.registro_proveedor.estado_registro} onChange={set("registro_proveedor", "estado_registro")}
            opciones={[{ value: "activo", label: "Activo" }, { value: "vigente", label: "Vigente" }, { value: "inactivo", label: "Inactivo" }]}
          />
        ...
        <SeccionRequisito emoji="" titulo="REQ-003 · Certificado de Antecedentes de Seguridad">
          ...
          <CampoSelect label="Resultado" value={form.certificado_seguridad.resultado} onChange={set("certificado_seguridad", "resultado")}
            opciones={[{ value: "aprobado", label: "Aprobado" }, { value: "sin_observaciones", label: "Sin Observaciones" }, { value: "con_observaciones", label: "Con Observaciones" }]}
          />
